...
export default class Category extends Component {
      ...
      },
      {
        ...
        render: (category) => ( // 返回需要显示的界面标签
          <span>
            ...
            {this.state.parentId==='0' ? <LinkButton onClick={() => this.showSubCategorys(category)}> Sub category</LinkButton> : null}
  ...
  render() {
    ...
    // card的左侧
    const title = parentId === '0' ? 'Catogary List' : (
      <span>
        <LinkButton onClick={this.showCategorys}>Category List</LinkButton>
